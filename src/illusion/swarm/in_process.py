...
* :class:`InProcessBackend` – implements
  :class:`~illusion.swarm.types.TeammateExecutor` and manages the dict of
  live asyncio Tasks.
"""
...
async def start_in_process_teammate(
    *,
    ...
    query_context:
        Optional pre-built
        :class:`~illusion.engine.query.QueryContext`.  When *None* this
...
async def _run_query_loop(
    ...
    """Drive :func:`~illusion.engine.query.run_query` until done or cancelled.
