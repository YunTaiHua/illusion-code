...
def _run_copilot_login() -> None:
    ...
    from illusion.api.copilot_auth import save_copilot_auth
    from illusion.auth.flows import DeviceCodeFlow
...
def auth_copilot_login() -> None:
    """Authenticate with GitHub Copilot via device flow (alias for 'illusion auth login copilot')."""
    _run_copilot_login()
...
def auth_copilot_logout() -> None:
    ...
    from illusion.api.copilot_auth import clear_github_token
