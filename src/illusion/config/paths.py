"""Path resolution for IllusionCode configuration and data directories.

Follows XDG-like conventions with ~/.illusion/ as the default base directory.
"""
...
def get_config_dir() -> Path:
    ...
    Resolution order:
    1. ILLUSION_CONFIG_DIR environment variable
    2. ~/.illusion/
    """
...
def get_config_file_path() -> Path:
    """Return the path to the main settings file (~/.illusion/settings.json)."""
...
def get_data_dir() -> Path:
    ...
    Resolution order:
    1. ILLUSION_DATA_DIR environment variable
    2. ~/.illusion/data/
    """
...
def get_logs_dir() -> Path:
    ...
    Resolution order:
    1. ILLUSION_LOGS_DIR environment variable
    2. ~/.illusion/logs/
    """
...
def get_project_config_dir(cwd: str | Path) -> Path:
    """Return the per-project .illusion directory."""
