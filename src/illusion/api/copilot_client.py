"""GitHub Copilot API client for IllusionCode.
...
class CopilotClient:
    ...
    github_token:
        ...
        token is loaded from ``~/.illusion/copilot_auth.json``.
    enterprise_url:
        ...
        *,
        ...
        if not token:
            raise AuthenticationFailure(
                "No GitHub Copilot token found. Run 'illusion auth copilot-login' first."
            )
